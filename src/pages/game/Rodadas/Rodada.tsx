...
export function Rodada() {
        ...
        const fetchRoundDetails = async () => {
            try {
                ...
                const fetchUserNames = async () => {
                    try {
                        const response = await axios.get(
                            'https://neurocooperacao-backend-8o0wti1lu-ghzoliveiras-projects.vercel.app/users',
                        );
    ...
    useEffect(() => {
        const fetchFundoRetido = async () => {
            try {
                const response = await axios.get(
                    `https://neurocooperacao-backend-8o0wti1lu-ghzoliveiras-projects.vercel.app/group/${groupId}/value/fundoRetido`,
                );
